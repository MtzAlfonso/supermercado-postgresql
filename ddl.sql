...
--
ALTER TABLE "CAJERO"
  ADD CONSTRAINT "FK_CAJERO_RECURSIVA" FOREIGN KEY (id_supervisor) REFERENCES "CAJERO" (id_empleado);

ALTER TABLE "CAJERO"
  ADD CONSTRAINT "FK_CAJERO_EMPLEADO" FOREIGN KEY (id_empleado) REFERENCES "EMPLEADO" (id_empleado);

--
-- TABLE: "COMPRA"
--
ALTER TABLE "COMPRA"
  ADD CONSTRAINT "FK_COMPRA_CAJERO" FOREIGN KEY (id_empleado) REFERENCES "CAJERO" (id_empleado);

ALTER TABLE "COMPRA"
  ADD CONSTRAINT "FK_COMPRA_PRODUCTO" FOREIGN KEY (id_produto) REFERENCES "PRODUCTO" (id_produto);

--
-- TABLE: "EMPLEADO"
--
ALTER TABLE "EMPLEADO"
  ADD CONSTRAINT "FK_EMPLEADO_CATALOGO" FOREIGN KEY (id_catalogo) REFERENCES "CATALOGO" (id_catalogo);

--
-- TABLE: "GERENTE"
--
ALTER TABLE "GERENTE"
  ADD CONSTRAINT "FK_GERENTE_EMPLEADO" FOREIGN KEY (id_empleado) REFERENCES "EMPLEADO" (id_empleado);

--
-- TABLE: "HISTORICO_PROD"
--
ALTER TABLE "HISTORICO_PROD"
  ADD CONSTRAINT "FK_HISTPROD_PROUDCTO" FOREIGN KEY (id_produto) REFERENCES "PRODUCTO" (id_produto);

ALTER TABLE "HISTORICO_PROD"
  ADD CONSTRAINT "FK_HISTPROD_STATUS" FOREIGN KEY (id_status) REFERENCES "STATUS" (id_status);

--
-- TABLE: "MEMBRESIA"
--
ALTER TABLE "MEMBRESIA"
  ADD CONSTRAINT "FK_MEMBRESIA_TARJETA" FOREIGN KEY (num_tarjeta) REFERENCES "TARJETA" (num_tarjeta);

ALTER TABLE "MEMBRESIA"
  ADD CONSTRAINT "FK_MEMBRESIA_COMPRA" FOREIGN KEY (id_compra) REFERENCES "COMPRA" (id_compra);

--
-- TABLE: "PRODUCTO"
--
ALTER TABLE "PRODUCTO"
  ADD CONSTRAINT "FK_PRODUCTO_STATUS" FOREIGN KEY (id_status) REFERENCES "STATUS" (id_status);

ALTER TABLE "PRODUCTO"
  ADD CONSTRAINT "FK_PRODUCTO_CATALOGO" FOREIGN KEY (id_catalogo) REFERENCES "CATALOGO" (id_catalogo);

--
-- TABLE: "SURTE_CATALOGO"
--
ALTER TABLE "SURTE_CATALOGO"
  ADD CONSTRAINT "FK_SURTECATALOGO_CATALOGO" FOREIGN KEY (id_catalogo) REFERENCES "CATALOGO" (id_catalogo);

ALTER TABLE "SURTE_CATALOGO"
  ADD CONSTRAINT "FK_SURTECATALOGO_PROVEEDOR" FOREIGN KEY (id_proveedor) REFERENCES "PROVEEDOR" (id_proveedor);
